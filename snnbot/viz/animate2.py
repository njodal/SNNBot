...
from ..body.vehicle2 import LEFT, RIGHT, Vehicle2
...
def frame(t, head_deg, neck_deg, busy, object_deg, raster, trace, scale,
          title="Version A: a PID on each joint", note=None):
    ...
    d.text((RASTER_L, 647), f"the last {WINDOW_MS / 1000:g} s", fill="black", font=FT,
           anchor="lm")
